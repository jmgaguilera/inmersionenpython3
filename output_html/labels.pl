...
$key = q/ch:servicios_web/;
$external_latex_labels{$key} = q|14|; 
$noresave{$key} = "$nosave";

$key = q/ch:pruebas_unitarias/;
$external_latex_labels{$key} = q|9|; 
$noresave{$key} = "$nosave";
...
$key = q/ch:expresionesregulares/;
$external_latex_labels{$key} = q|5|; 
$noresave{$key} = "$nosave";

$key = q/sec:shell/;
$external_latex_labels{$key} = q|0.7|; 
$noresave{$key} = "$nosave";
