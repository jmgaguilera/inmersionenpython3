...
Una vez estás en la línea de comando del sistema operativo correspondiente, deberías ser capaz de ejecutar la consola interactiva de Python. En Línux o Mac OS X, teclea \codigo{python3} y pulsa \codigo{ENTER}. Si todo va bien, deberías ver algo como esto:
